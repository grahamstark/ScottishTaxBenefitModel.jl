module Results
    ...
    function aggregate!( hh :: Household{T}, hres :: HouseholdResult{T} ) where T
        ...
        @assert hres.bhc_net_income > 0 "zero bhc_net_income for hid=$(hh.hid) year=$(hh.data_year) bhc_net_income $(hres.bhc_net_income) HOUSING_BENEFIT=$(hres.income[HOUSING_BENEFIT]) COUNCIL_TAX_BENEFIT=$(hres.income[COUNCIL_TAX_BENEFIT]) hres.income[COUNCIL_TAX_BENEFIT]=$(hres.income[COUNCIL_TAX_BENEFIT])"
