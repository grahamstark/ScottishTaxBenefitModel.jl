module Results
    ...
    function aggregate!( hh :: Household{T}, hres :: HouseholdResult{T} ) where T
        ...
        hres.eq_bhc_net_income = hres.bhc_net_income*TWO_ADS_EQ_SCALES.oecd_bhc/hh.equivalence_scales.oecd_bhc
        hres.eq_ahc_net_income = hres.ahc_net_income*TWO_ADS_EQ_SCALES.oecd_ahc/hh.equivalence_scales.oecd_ahc
    end
