...
function create_adults(
    ...
    for pn in 1:num_adults
        ...
        println( "frs_person.person=$(frs_person.person) frs_person.sernum=$(frs_person.sernum) frs_person.benunit=$(frs_person.benunit)")

        println( "hbaidata=$(hbaidata)")
