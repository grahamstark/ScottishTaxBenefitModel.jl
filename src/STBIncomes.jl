...
const MEANS_TESTED_BENS = union(fill(WORKING_TAX_CREDIT,UNIVERSAL_CREDIT), [SCOTTISH_CHILD_PAYMENT,COUNCIL_TAX_BENEFIT,DISCRETIONARY_HOUSING_PAYMENTS] )
...
const SCOTTISH_BENEFITS = union( 
    ...
    [SCOTTISH_CHILD_PAYMENT,DISCRETIONARY_HOUSING_PAYMENTS] ) # FIXME plus ...
