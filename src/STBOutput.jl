...
function one_gain_lose( dhh :: DataFrame, col :: Symbol ) :: Tuple{DataFrame,DataFrame}
    ...
    gavch.avch = (gavch.people_weighted_post_income_sum .- gavch.people_weighted_pre_income_sum) ./ gavch.weighted_people_sum # => average change for each group per person
