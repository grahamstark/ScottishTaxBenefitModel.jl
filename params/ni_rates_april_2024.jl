...
function load_ni_rates_april_2024!( sys :: TaxBenefitSystem )
    # NI
    # From April 6 2024-5th April 2024
    # https://www.gov.uk/national-insurance-rates-letters
    # https://www.bishopfleming.co.uk/insights/national-insurance-changes-2024
    ...
    sys.ni.class_2_threshold = 0.0;
    sys.ni.class_2_rate = 0.0;
    sys.ni.class_4_rates = [0.0, 8.0, 2.0 ]
    sys.ni.class_4_bands = [12_570.0, 50_270.0, 99999999999999.9 ]
end

load_ni_rates_april_2024!( sys )