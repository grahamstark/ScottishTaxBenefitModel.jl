...
sys.it.company_car_charge_by_CO2_emissions =  Fuel_Type_Dict([ Missing_Fuel_Type=>0.1,
    No_Fuel=>0.1,
    Other=>0.1,
    Dont_know=>0.1,
    Petrol=>0.25, # dunno
...
sys.ni.class_2_threshold ::RT = 6_365.0;
sys.ni.class_2_rate ::RT = 3.05;
...
sys.lmt.savings_credit.threshold_couple :: RT =244.12
...
sys.uc.limited_capcacity_for_work_activity:: RT = 343.63
sys.uc.carer = 163.73
...
sys.age_limits.savings_credit_to_new_state_pension = Date = Date( 2016, 04, 06 )
...
sys.hr.rooms_rent_reduction = (14,25)
sys.hr.single_room_age = 35
sys.hr.brmas = loadBRMAs( 4, RT, DEFAULT_BRMA_2021 ) 
...
# = PersonalIndependencePayment{RT}()
...
sys.nmt_bens.widows_pension.age_amounts = Vector{RT}([113.97,105.39,96.81,88.24,79.66,71.08,62.50,53.92,45.34,36.77])
