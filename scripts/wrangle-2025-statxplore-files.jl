...
("dla-by-age-and-region-18-24-table_2025-03-19_13-45-40.xlsx",4,13),
("dla-by-age-and-region-02-18-table_2025-03-19_15-32-08.xlsx",4,13),
("pip-by-age-and-region-13-19-table_2025-03-19_16-23-07.xlsx",1,10),
("pip-by-age-and-region-19-25-table_2025-03-19_16-04-49.xlsx",1,10)
]
...
for tab in tables
    ...
    d1 = XLSX.readtable( infname, startsheet, "B:AB"; first_row=11)|>DataFrame
    delete!(d1,1)
    println( "1st sheet data")
    pretty_table( d1 )
    nrows,ncols = size(d1)    
    for sheet in (startsheet+1):endsheet
        d2 = XLSX.readtable( infname, sheet, "B:AB"; first_row=11)|>DataFrame
        delete!(d2,1)
